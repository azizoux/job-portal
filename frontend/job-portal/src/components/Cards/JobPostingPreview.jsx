...
const JobPostingPreview = ({ formData, setIsPreview }) => {
  ...
  return (
    <div
      className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-purple-50/20 py-8 px-4
    sm:px-6 lg:px-8"
    >
        ...
        <div className="mb-8 backdrop-blur-sm bg-white/80 border border-white/20 shadow-xl rounded-2xl px-6 pt-6">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="group flex items-center space-x-2 px-6 py-3 text-xs md:text-sm font-medium text-gray-600 hover:text-white bg-white/50 hover:bg-gradient-to-r hover:from-blue-500 to-blue-600
              border border-gray-200 hover:border-transparent rounded-xl transition-all duration-300 shadow-lg shadow-gray-100 hover:shadow-xl transform hover:-translate-y-0.5"
            >
          ...
          <div className="">
            ...
            <div className="relative bg-white px-0 pb-8 mt-8 border-b border-gray-100">
              <div className="relative z-10">
                <div className="flex items-start justify-between mb-0">
                  ...
                  {user?.companyLogo ? (
                    <img
                      ...
                      alt="Company Logo"
                      className="h-16 w-16 md:w-20 md:h-20 object-cover rounded-2xl border-4 border-white/20 shadow-lg"
                    />
                  ) : (
                ...
                <div className="flex flex-wrap gap-3 mt-6 md:mt-0">
                  ...
                  <div
                    className="flex items-center space-x-1 px-4 py-2 bg-gray-50 text-sm text-gray-700
            ...
            <div className="px-0 pb-8 space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gradient-to-br from-purple-50 to-pink-50 border border-gray-100 rounded-xl p-6">
                  <div className="text-sm text-gray-700 leading-relaxed whitespace-pre-wrap">
