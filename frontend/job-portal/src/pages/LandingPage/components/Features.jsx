...
import { employerFeatures, jobSeekerFreatures } from "../../../utils/data";
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Wether you're looking for your next opportinuity or the perfect
            candidate, we have the tools and features to makes it happens.
          </p>
        </div>
